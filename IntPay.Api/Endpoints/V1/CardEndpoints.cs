...
public static class CardEndpoints
{
    public static RouteGroupBuilder MapCardEndpoints(this RouteGroupBuilder api)
    {
        ...
        api.MapPost("/cards/{cardId:int}/lifecycle-status", async (int cardId, SetCardLifecycleStatusRequest? body, IntPayService service) =>
            {
                try
                {
                    body = body ?? throw new ArgumentException("Request body is required.");
                    ...
                    var data = await service.SetVirtualCardLifecycleStatusAsync(cardId, body.Status, body.ActingUserId);
            ...
            .WithName("SetCardLifecycleStatus");
